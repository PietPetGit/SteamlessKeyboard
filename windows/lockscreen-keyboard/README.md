...
2. The right trackpad moves the mouse — click **Ease of Access** <img src="../data/images/glyphs/glyph_easeofaccess.png width="18 style="vertical-align:middle" alt="Ease of Access" style="vertical-align:middle"> (bottom-right).
