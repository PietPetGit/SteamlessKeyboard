...
class VirtualGamepad:
    ...
    def update(self, sci):
        ...
        lt = _clamp(sci.ltrig >> 7, 0, 255)
        rt = _clamp(sci.rtrig >> 7, 0, 255)
        lx = _clamp(sci.lstick_x, -32768, 32767)
        ly = _clamp(sci.lstick_y, -32768, 32767)
        rx = _clamp(sci.rstick_x, -32768, 32767)
        ry = _clamp(sci.rstick_y, -32768, 32767)
