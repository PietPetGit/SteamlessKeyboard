...
class _Watcher:
    ...
    def on_input(self, sc, sci):
        ...
        # Left stick → arrow keys (desktop mode, no Steam).
        self._handle_arrow_stick(sci, steam_now, time.monotonic())

        # Right stick → mouse (desktop mode).
        self._handle_mouse_stick(sci, time.monotonic())
