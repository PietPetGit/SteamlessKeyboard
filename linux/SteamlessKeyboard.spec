...
a = Analysis(
    ...
    hiddenimports=['pynput.keyboard._xorg', 'pynput.mouse._xorg', 'PIL._tkinter_finder', 'sdl3w', 'pystray._appindicator', 'pystray._util.gtk', 'pystray._util.notify_dbus', 'gi', 'gi.repository.Gtk', 'gi.repository.AyatanaAppIndicator3'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
